...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    { to: "/video", icon: <Video size={20} />, text: "VideoCall" },
    { to: "/calendar", icon: <Calendar size={20} />, text: "Meeting Calender" },
    { to: "/pdf", icon: <FileDigit size={20} />, text: "Pdf Upload" },
    { to: "/payment", icon: <Wallet size={20} />, text: "Manage Wallets" },
  ];
  ...
  const investorItems = [
    ...
    { to: "/video", icon: <FileText size={20} />, text: "VideoCall" },
    { to: "/calendar", icon: <FileText size={20} />, text: "Meeting Calender" },
    { to: "/pdf", icon: <FileText size={20} />, text: "Pdf Upload" },
    { to: "/payment", icon: <FileText size={20} />, text: "Manage Wallets" },
  ];
